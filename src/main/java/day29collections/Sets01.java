...
public class Sets01 {
    public static void main(String[] args) {
        /*
        1)Setler tekrarisz eleman(uniqe) depolamak icin kullanilir
        2)3 tane Set class vardir
            a)HashSet Class:(setler in en hızlısı)
            ...
            b)LinkedHashSet Class:
                 "LinkedHashSet" ler elemanlari sizin verdiginiz siraya gore dizdiklerinden (insert order) "HashSet"lere gore yavastirlar
                " LinkedHashSet"ler tekrarsiz eleman depolamak icindir

             c)TreeSet Class:
                 TressSet ler elemanlari natural order (kucukten buyuge yada alfabetik sira) a gore dizerler
                 TreeSet  ler elemaanlari natural order a gore dizdiklerinden cok yavastirlar
                 En yavas set "TreeSet" tir

          3)TreeSet cok yavas oldugundan mumkun oldugu kadar TreeSet kullanmamaya calısir
