...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        //Ornek 5: "t" stringindeki tum harfler disindaki tum harfler disinda tum charaecterleri"+" ceviriniz
        String t5=t.replaceAll("[^a-zA-z]","+");
        System.out.println(t5);


        //Ornek6:"t" stringindeki spaceler dısındaki tum characterleri "?" e ceviriniz
        String t6=t.replaceAll("[^ ]","?");
        System.out.println(t6);

        //Ornek7:"t" Stringindeki sesli harfler disindaki tum characterleri "&" e ceviriniz
